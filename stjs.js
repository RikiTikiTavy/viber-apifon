...
stjs.converters = {
	...
	Enum: function Enum(s, type) {
		return eval(type.arguments[0])[s];
	}
};

stjs.serializers = {
	Date: function Date(d, type) {
		function pad(n) {
			return n < 10 ? "0" + n : "" + n;
		}
		if (d) {
...
/** exception **/
var Throwable = function Throwable(message, cause) {
	Error.call(this);
...
var Exception = function Exception(message, cause) {
	Throwable.call(this, message, cause);
};
stjs.extend(Exception, Throwable, [], function (constructor, prototype) {}, {});

var RuntimeException = function RuntimeException(message, cause) {
